    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (doesUserChooseToPlantFlag(userActionInput)) {
                ...
                if (isLandMinCell(selectedRowIndex, selectedColIndex)) {
                    board[selectedRowIndex][selectedColIndex] = "☼";
        ...
        for (int row = 0; row < 8; row++) {
            for (int col = 0; col < 10; col++) {
                ...
                if (!isLandMinCell(row, col)) {
                    ...
                    if (row - 1 >= 0 && col + 1 < 10 && isLandMinCell(row - 1, col + 1)) {
                        count++;
                    }
                    if (col - 1 >= 0 && isLandMinCell(row, col - 1)) {
                        count++;
                    }
                    if (col + 1 < 10 && isLandMinCell(row, col + 1)) {
                        count++;
                    }
                    if (row + 1 < 8 && col - 1 >= 0 && isLandMinCell(row + 1, col - 1)) {
                        count++;
                    }
                    if (row + 1 < 8 && isLandMinCell(row + 1, col)) {
                        count++;
                    }
                    if (row + 1 < 8 && col + 1 < 10 && isLandMinCell(row + 1, col + 1)) {
                        count++;
                    }
